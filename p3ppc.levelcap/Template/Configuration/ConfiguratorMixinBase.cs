...
namespace p3ppc.levelcap.Template.Configuration
{
    /// <summary>
    ...
    public class ConfiguratorMixinBase
    {
        ...
        public virtual IUpdatableConfigurable[] MakeConfigurations(string configFolder)
        {
            ...
            {
                (IUpdatableConfigurable)Configurable<Config>.FromFile(Path.Combine(configFolder, "Config.json"), "Default Config")
            };
        }
